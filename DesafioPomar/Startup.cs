...
using DesafioPomar.Services.Concrete;
...
namespace DesafioPomar
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IService<Arvore>,BaseService<Arvore>>();
            services.AddScoped<IService<Colheita>,BaseService<Colheita>>();
            services.AddScoped<IService<Especie>,BaseService<Especie>>();
            services.AddScoped<IService<Grupo>,BaseService<Grupo>>();
